let comandos = {
    discord:{respostas: ['https://discord.gg/D6ZcfJTH',
    'entra ai: https://discord.gg/D6ZcfJTH',
    'entra ai: https://discord.gg/D6ZcfJTH por favor']
},

    instagram:{respostas: ['segue ai: https://www.instagram.com/guggm/?hl=pt-br',
    'https://www.instagram.com/guggm/?hl=pt-br']
},
    piada:{respostas: ['é pave ou pa cume',
    ...
    agua:{respostas: ['💦💦VAI BEBE AGUA JOVEM DESOCUPADO 🤗💦💦',
    'vai se hidratar, ta parecendo um difunto']},

    saindo:{respostas: ['opa, va na paz',
    'flw ate a proxima',
    'vai me vai me abandonar msm? igualzinho ao meu pai?']},



//comando:{respostas: [resposta1, resposta2]},
