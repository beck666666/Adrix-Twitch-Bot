...
//comandos
	let comandos = [
		...
		{chamadas: ['comandos especiais', '!comandos especiais'], respostas: [`____________ MercyWing1 o comando:!colocar foto PogChamp , este comando exige um emote no final ele vai colocar o emote que vc escolheu como seu avatar no chat da tela MercyWing2  MercyWing1 ; Tambem tem o comando para mudar as cores do overlay, esse comando so pode ser ultilizado comprando a recompensa "destacar minha mensagem" e digitando uma cor valida, as cores validas são essas: https://pt.wikipedia.org/wiki/Lista_de_cores digite o nome da cor com a primeira letra maiuscula e sem !!! MercyWing2`]},
